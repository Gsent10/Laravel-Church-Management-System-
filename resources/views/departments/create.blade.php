        ...
        <div class="card-body">
            <form method="POST" action="{{ route('departments.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="department" type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="{{ old('department') }}" required autocomplete="off" autofocus>
